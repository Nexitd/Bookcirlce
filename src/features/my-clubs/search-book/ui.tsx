...
export const SearchBook = ({ onSearch }: SearchBookPropsType) => {
    ...
    return <div className="search">
        <form className="search__form" onSubmit={(e) => {
            ...
            <div className="search__item">
                ...
                <input onChange={(e) => setSearchValue(e.target.value)} type="text" className="search__item_input" placeholder="Поиск книжных клубов" required />
            </div>
