...
export const SearchBook = ({ onSearch, placeholder = "Поиск книжных клубов" }: SearchBookPropsType) => {
    ...
    return <div className="search">
        <form className="search__form" onSubmit={(e) => {
            ...
            <div className="search__item">
                ...
                <input onChange={(e) => setSearchValue(e.target.value)} type="text" className="search__item_input" placeholder={placeholder} required />
            </div>
