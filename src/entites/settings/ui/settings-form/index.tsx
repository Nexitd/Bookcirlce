...
export const SettingsForm = () => {
    ...
    const showModal = useCallback(() => setIsModalVisible(prev => !prev), [isModalVisible])
        ...
        >
            <Form className='settings__form'>
                <div className='settings__form_container'>
                    <div className='settings__form_item'>
                        ...
                        <div className='settings__form_blocks'>
                            ...
                            <p className='settings__form_subtext'>Дата рождения формате ДД/ММ/ГГ</p>
                        </div>
                        ...
                        <div className="settings__form_blocks">
                            ...
                            <label className='settings__form_blocks-file' htmlFor='image'>
                                ...
                                <div className='settings__form_blocks-filename'>{fileName}</div>
                                <Field id="image" name="image" type="file" onChange={(e: any) => setFileName(e.target.files[0].name)} />
                            </label>
                        </div>
                    </div>
                    <div className='settings__form_item'>
                        ...
                        <div className="settings__form_blocks">
                            ...
                            <Field id="sex" name="sex" as="select" defaultValue={currentUser.sex}>
                        ...
                        <div className="settings__form_blocks settings__form_blocks-id">
                            ...
                            <div className='settings__copy'>
                                ...
                                <button className='settings__copy_btn' type="button" onClick={() => btnCopyClick(currentUser.id.toString())}>
                    ...
                    <div className="settings__form_item">
                        <div className="settings__form_blocks">
                            ...
                            <div className='settings__form_blocks-flex'>
                                ...
                                <div className='settings__form_blocks-change' onClick={() => {
                ...
                <div className="settings__form_controls">
                    <Button text='Удалить профиль' className='control__delete control__btn' onClick={() => {
                        setModalType("delete");
                        showModal();
                    }} />
                    <div>
                        <Button text='Отменить' className='control__btn control__cancel' />
